...
#buscar{
 ...
 <!--end of modal-->
        ...
        <form class="form-horizontal" method="post" action="propietario_add.php" enctype='multipart/form-data'>
 ...
 <div class="row">
                    ...
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                       ...
                       <div class="col-md-4 btn-print">
                      <div class="form-group">
                          <input type="text" class="form-control pull-right" id="direccion" name="direccion"  placeholder="direccion" >
                      </div>
                    </div>
                           <div class="col-md-4 btn-print">
